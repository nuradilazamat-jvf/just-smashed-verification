  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const p = partnersSnap.docs.map((d) => ({ id: d.id, ...d.data() }));
        setPartners(p);
        ...
        console.error(e);
        setError(
          "Fehler beim Laden der Admin-Daten. Bitte später noch einmal versuchen."
        );
      } finally {
        setLoading(false);
      }
        ...
        <section className="bg-white border rounded-2xl p-4 md:p-6">
          ...
          <form onSubmit={handleCreatePartner} className="space-y-2 mb-6">
            ...
            <input
              ...
              onChange={(e) =>
                setPartnerForm((f) => ({ ...f, id: e.target.value }))
              }
            ...
            <input
              ...
              onChange={(e) =>
                setPartnerForm((f) => ({ ...f, shortName: e.target.value }))
              }
              className="w-full border rounded px-2 py-1 text-sm"
            />
            <button
          ...
          <form onSubmit={handleCreateLocation} className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                setLocationForm((f) => ({ ...f, partnerId: e.target.value }))
              }
              className="w-full border rounded px-2 py-1 text-sm"
            />
            <input
              ...
              onChange={(e) =>
                setLocationForm((f) => ({ ...f, id: e.target.value }))
              }
              className="w-full border rounded px-2 py-1 text-sm"
            />
            <input
        ...
        <section className="bg-white border rounded-2xl p-4 md:p-6">
          ...
          <form onSubmit={handleCreateUserProfile} className="space-y-2">
            ...
            <p className="text-[11px] text-slate-500 mb-1">
              Schritt 1: User in Firebase Authentication anlegen (E-Mail +
              Passwort). Schritt 2: UID hier eintragen und Profil mit Rolle /
              Partner verbinden. Schritt 3: Custom Claims mit admin-scripts
              setzen.
            </p>
            <input
              type="text"
              ...
              value={userForm.uid}
              onChange={(e) =>
                setUserForm((f) => ({ ...f, uid: e.target.value }))
              }
              className="w-full border rounded px-2 py-1 text-sm"
            />
            <input
              ...
              <>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setUserForm((f) => ({
                      ...f,
                      locationIdsText: e.target.value,
                    }))
                  }
                  className="w-full border rounded px-2 py-1 text-sm"
                />
